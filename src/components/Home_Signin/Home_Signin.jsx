                    ...
                    <div className="home-inner-right">
                        ...
                        <div className="home-inner-right-icon">
                            ...
                            <div className="home-inner-right-icon-cross">
                                <img src="https://www.pinclipart.com/picdir/big/538-5385185_grey-cross-icon-png-clipart.png" />
                            </div>
                        ...
                        <div className="home-inner-right-three">
                            <div className="home-inner-right-three-inner">
                                ...
                                <div className="home-inner-right-three-inner-text">Continue with Twitter</div>
                            </div>
                        </div>

                        <div className="home-inner-right-four">
                            Maybe Later
                        </div>

                        <div className="home-inner-right-five">
                            RECOMMENDED TOPICS
                        </div>
                        ...
                        <div className="home-inner-right-eight">
                         ...
                         <div className="home-inner-right-nine">
                            WHOM TO FOLLOW
                        </div>
