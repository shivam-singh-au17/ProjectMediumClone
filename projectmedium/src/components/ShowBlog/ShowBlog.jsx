      ...
      <div className="myBlogSec">
        ...
        <div className="userInfo01 mb-5">
          <p>
            ...
            last. I want the chance to cooperate later. While I don’t have much
            evidence on how other managers handle these situations, a graceful
            exit between us leads to better future outcomes. And that is how we
            say goodbye.
          </p>
        </div>
        <div className="allOptions">
